...
#define WLY_ASplitsGame_Text "A SPLITS GAME"
...
#define WLY_Title_Text "GAME TITLE"
#define WLY_Title_TextSize 0.1
#define WLY_Title_TextWeight 0.005
#define WLY_Title_TextKern 0.02
...
#define WLY_MainCredit_StartY 1.35f
...
#define WLY_KSThx2_Text "ALL OF MY KICKSTARTER BACKERS"
...
#define WLY_MoreThx7_Text "STEPHEN CLARK"
...
#define WLY_MoreThx8_Text "ZEKE VIRANT"
...
#define WLY_MoreThx9_Text "BENNETT FODDY"
#define WLY_MoreThx9_TextSize 0.025
#define WLY_MoreThx9_TextWeight 0.0025
#define WLY_MoreThx9_TextKern 0.01
#define WLY_MoreThx9_StartY 2.35f

#define WLY_SpecialDedication1_Text "INSERT DEDICATION HERE"
#define WLY_SpecialDedication1_TextSize 0.025
#define WLY_SpecialDedication1_TextWeight 0.0025
#define WLY_SpecialDedication1_TextKern 0.01
#define WLY_SpecialDedication1_StartY 2.55f

#define WLY_SpecialDedication2_Text "HOW DEDICATORY WHAT SENTIMENT"
#define WLY_SpecialDedication2_TextSize 0.025
#define WLY_SpecialDedication2_TextWeight 0.0025
#define WLY_SpecialDedication2_TextKern 0.01
#define WLY_SpecialDedication2_StartY 2.6f
...
#define WLY_ScrollPerSecond 60.0f
...
static splitslib_sf_Stringbox stringbox_MoreThx9;
...
void wly_Credits_Draw()
{
    SplitCanvas_BeginTextureMode();
        ...
        splitslib_sf_DrawString(
            stringbox_MoreThx9.id,
            stringbox_MoreThx9.pos.x, stringbox_MoreThx9.pos.y);
            
        splitslib_sf_DrawString(
            stringbox_SpecialDedication1.id,
            stringbox_SpecialDedication1.pos.x, stringbox_SpecialDedication1.pos.y);
        splitslib_sf_DrawString(
            stringbox_SpecialDedication2.id,
            stringbox_SpecialDedication2.pos.x, stringbox_SpecialDedication2.pos.y);        
...
static void FreeStrings(){
    ...
    splitslib_sf_FreeString(stringbox_MoreThx9.id);
...
static void InitStrings()
{
    ...
    splitslib_sf_InitStringbox(
        &stringbox_MoreThx9,
        WLY_MoreThx9_Text,
        WLY_MoreThx9_TextSize,
        WLY_MoreThx9_TextWeight,
        WLY_MoreThx9_TextKern,
        WLY_MoreThx9_StartY);
...
static void ScrollCredits(){
    ...
    stringbox_MoreThx9.pos.y -= scrollAmount;
